...
[[nodiscard]] DUDE_API auto ParseReporterSpec(std::string_view spec) -> std::expected<ReporterSpec, ReporterError>;
...
[[nodiscard]] DUDE_API auto CreateReporter(std::string_view spec, ReporterConfig const& consoleConfig = {})
