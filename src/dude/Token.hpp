...
[[nodiscard]] DUDE_API auto TokenTypeName(TokenType type) -> std::string_view;

/// @brief Returns true if the token type is a C++ keyword.
[[nodiscard]] DUDE_API auto IsKeyword(TokenType type) -> bool;

/// @brief Returns true if the token type is a C#-specific keyword.
[[nodiscard]] DUDE_API auto IsCSharpKeyword(TokenType type) -> bool;

/// @brief Returns true if the token type is a Python-specific keyword.
[[nodiscard]] DUDE_API auto IsPythonKeyword(TokenType type) -> bool;

/// @brief Returns true if the token type is a comment (line or block).
[[nodiscard]] DUDE_API auto IsComment(TokenType type) -> bool;

/// @brief Returns true if the token type is a literal (numeric, string, or char).
[[nodiscard]] DUDE_API auto IsLiteral(TokenType type) -> bool;

/// @brief Returns true if the token type is an operator or punctuation.
[[nodiscard]] DUDE_API auto IsOperatorOrPunctuation(TokenType type) -> bool;
